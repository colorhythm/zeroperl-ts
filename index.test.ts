...
describe("Unicode Character Handling", () => {
    ...
    describe("Unicode in Perl Operations", () => {
        ...
        it.skip("should handle Unicode in Perl string operations with 'use utf8' pragma", async () => {
            let output = "";
            const perl = await ZeroPerl.create({
                stdout: (data) => {
                    output += typeof data === "string" ? data : new TextDecoder().decode(data);
        ...
        it.skip("should handle Unicode passed via setVariable without pragma", async () => {
            let output = "";
            const perl = await ZeroPerl.create({
                stdout: (data) => {
                    output += typeof data === "string" ? data : new TextDecoder().decode(data);
        ...
        it.skip("should handle Unicode in host functions with pragma", async () => {
            const perl = await ZeroPerl.create();
    ...
    describe("Unicode Edge Cases", () => {
        ...
        it.skip("should handle Unicode with null bytes", async () => {
            const perl = await ZeroPerl.create();
            const text = "안녕\0하세요";
...
describe("Perl Build Configuration", () => {
    ...
    it.skip("should use long long for 64-bit types", async () => {
        let output = "";
        const perl = await ZeroPerl.create({
            stdout: (data) => {
                output += typeof data === "string" ? data : new TextDecoder().decode(data);
...
describe("Perl I/O Operations", () => {
    it.skip("should handle binary read-seek-read pattern", async () => {
        const fs = new MemoryFileSystem({ "/": "/" });
    ...
    it.skip("should correctly pack and unpack 64-bit integers", async () => {
        let output = "";
        const perl = await ZeroPerl.create({
            stdout: (data) => {
                output += typeof data === "string" ? data : new TextDecoder().decode(data);
